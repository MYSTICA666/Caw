...
- Services to run as a node:A “Storage Node” system where the community can provide their own storage (HDD, cloud server) to make CAW’s ideal of “perpetual storage” a reality. 
